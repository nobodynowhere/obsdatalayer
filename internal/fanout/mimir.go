...
func RegisterMimir(mux *http.ServeMux, h *config.ConfigHolder, p *proxy.Proxy, m *metrics.Metrics) {
	...
	registerMimirRead(mux, "GET /api/mimir/prometheus/api/v1/query_exemplars", h, p, "query_exemplars", "/prometheus/api/v1/query_exemplars")
	registerMimirRead(mux, "POST /api/mimir/prometheus/api/v1/query_exemplars", h, p, "query_exemplars", "/prometheus/api/v1/query_exemplars")
	...
	registerMimirRead(mux, "POST /api/mimir/prometheus/api/v1/read", h, p, "read", "/prometheus/api/v1/read")
	registerMimirRead(mux, "GET /api/mimir/prometheus/api/v1/cardinality/active_series", h, p, "cardinality", "/prometheus/api/v1/cardinality/active_series")
	registerMimirRead(mux, "POST /api/mimir/prometheus/api/v1/cardinality/active_series", h, p, "cardinality", "/prometheus/api/v1/cardinality/active_series")
	registerMimirRead(mux, "GET /api/mimir/prometheus/api/v1/cardinality/label_names", h, p, "cardinality", "/prometheus/api/v1/cardinality/label_names")
	registerMimirRead(mux, "POST /api/mimir/prometheus/api/v1/cardinality/label_names", h, p, "cardinality", "/prometheus/api/v1/cardinality/label_names")
	registerMimirRead(mux, "GET /api/mimir/prometheus/api/v1/cardinality/label_values", h, p, "cardinality", "/prometheus/api/v1/cardinality/label_values")
	registerMimirRead(mux, "POST /api/mimir/prometheus/api/v1/cardinality/label_values", h, p, "cardinality", "/prometheus/api/v1/cardinality/label_values")
	registerMimirRead(mux, "GET /api/mimir/prometheus/api/v1/status/buildinfo", h, p, "", "/prometheus/api/v1/status/buildinfo")
	registerMimirRead(mux, "GET /api/mimir/prometheus/api/v1/format_query", h, p, "", "/prometheus/api/v1/format_query")
	registerMimirRead(mux, "POST /api/mimir/prometheus/api/v1/format_query", h, p, "", "/prometheus/api/v1/format_query")
	registerMimirRead(mux, "GET /api/mimir/prometheus/api/v1/rules", h, p, "", "/prometheus/api/v1/rules")
	registerMimirRead(mux, "GET /api/mimir/prometheus/api/v1/alerts", h, p, "", "/prometheus/api/v1/alerts")

	registerMimirTenantConfig(mux, "GET /api/mimir/prometheus/config/v1/rules", h, p, "/prometheus/config/v1/rules")
	registerMimirTenantConfig(mux, "GET /api/mimir/prometheus/config/v1/rules/{namespace}", h, p, "/prometheus/config/v1/rules/{namespace}")
	registerMimirTenantConfig(mux, "GET /api/mimir/prometheus/config/v1/rules/{namespace}/{groupName}", h, p, "/prometheus/config/v1/rules/{namespace}/{groupName}")
	registerMimirTenantConfig(mux, "POST /api/mimir/prometheus/config/v1/rules/{namespace}", h, p, "/prometheus/config/v1/rules/{namespace}")
	registerMimirTenantConfig(mux, "DELETE /api/mimir/prometheus/config/v1/rules/{namespace}/{groupName}", h, p, "/prometheus/config/v1/rules/{namespace}/{groupName}")
	registerMimirTenantConfig(mux, "DELETE /api/mimir/prometheus/config/v1/rules/{namespace}", h, p, "/prometheus/config/v1/rules/{namespace}")
